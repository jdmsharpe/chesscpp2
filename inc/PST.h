...
constexpr int pawn[64] = {0,  0,  0,  0,   0,   0,  0,  0,   // Rank 1
...
constexpr int knight[64] = {-50, -40, -30, -25, -25, -30, -40, -50, -40, -20, 0,   5,   5,
                            0,   -20, -40, -30, 5,   10,  15,  15,  10,  5,   -30, -25, 5,
                            15,  20,  20,  15,  5,   -25, -25, 5,   15,  20,  20,  15,  5,
                            -25, -30, 5,   10,  15,  15,  10,  5,   -30, -40, -20, 0,   5,
                            5,   0,   -20, -40, -50, -40, -30, -25, -25, -30, -40, -50};

// Bishops - prefer long diagonals and center
constexpr int bishop[64] = {-20, -10, -10, -10, -10, -10, -10, -20, -10, 5,   0,   0,   0,
                            0,   5,   -10, -10, 10,  10,  10,  10,  10,  10,  -10, -10, 0,
                            10,  15,  15,  10,  0,   -10, -10, 5,   5,   15,  15,  5,   5,
                            -10, -10, 0,   5,   10,  10,  5,   0,   -10, -10, 5,   0,   0,
                            0,   0,   5,   -10, -20, -10, -10, -10, -10, -10, -10, -20};

// Rooks - prefer 7th rank and open files
constexpr int rook[64] = {0,  0, 0, 5, 5, 0, 0, 0,  20, 20, 20, 20, 20, 20, 20, 20,
                          -5, 0, 0, 0, 0, 0, 0, -5, -5, 0,  0,  0,  0,  0,  0,  -5,
                          -5, 0, 0, 0, 0, 0, 0, -5, -5, 0,  0,  0,  0,  0,  0,  -5,
                          -5, 0, 0, 0, 0, 0, 0, -5, 0,  0,  0,  0,  0,  0,  0,  0};

// Kings - stay safe in middlegame
constexpr int kingMiddle[64] = {20,  30,  10,  0,   0,   10,  30,  20,  -10, -20, -20, -20, -20,
                                -20, -20, -10, -20, -30, -30, -40, -40, -30, -30, -20, -30, -40,
...
constexpr int kingEndgame[64] = {-20, -10, -10, -10, -10, -10, -10, -20, -10, 0,   5,   5,   5,
                                 5,   0,   -10, -10, 5,   10,  15,  15,  10,  5,   -10, -10, 5,
                                 15,  20,  20,  15,  5,   -10, -10, 5,   15,  20,  20,  15,  5,
                                 -10, -10, 5,   10,  15,  15,  10,  5,   -10, -10, 0,   5,   5,
                                 5,   5,   0,   -10, -20, -10, -10, -10, -10, -10, -10, -20};
